TestFun MATLAB .NET Assembly (.NET Component)
...
TestFun_overview.html - HTML overview documentation file for the generated component. It 
                        contains the requirements for accessing the component and for 
                        generating arguments using the MWArray class hierarchy.

TestFun.xml - This file contains the code comments for the TestFun component classes and 
                        ...
                        online documentation for the TestFun component.
