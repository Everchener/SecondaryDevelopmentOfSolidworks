...
namespace OptSwAddin {
    /// <summary>
    /// Summary description for OptSwAddin.
    /// </summary>
    [Guid("5812f44b-3b2a-4ca3-b874-c525f907264e"), ComVisible(true)]
    [SwAddin(
        Description = "OptSwAddin description",
        Title = "OptSwAddin",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin {
        ...
        public void AddCommandMgr() {
            ...
            string Title = "C# Addin测试", ToolTip = "C# Addindesu";
            ...
            icons[0] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.toolbar20x.png", thisAssembly);
            icons[1] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.toolbar32x.png", thisAssembly);
            icons[2] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.toolbar40x.png", thisAssembly);
            icons[3] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.toolbar64x.png", thisAssembly);
            icons[4] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.toolbar96x.png", thisAssembly);
            icons[5] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.toolbar128x.png", thisAssembly);

            mainIcons[0] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.mainicon_20.png", thisAssembly);
            mainIcons[1] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.mainicon_32.png", thisAssembly);
            mainIcons[2] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.mainicon_40.png", thisAssembly);
            mainIcons[3] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.mainicon_64.png", thisAssembly);
            mainIcons[4] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.mainicon_96.png", thisAssembly);
            mainIcons[5] = iBmp.CreateFileFromResourceBitmap("OptSwAddin.mainicon_128.png", thisAssembly);
            ...
            cmdIndex2 = cmdGroup.AddCommandItem2("打开优化窗口1", -1, "打开优化窗口2", "打开优化窗口3", 2, "NewButton", "", mainItemID3, menuToolbarOption);
